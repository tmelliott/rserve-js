...
exports.my_ArrayBufferView = exports.EndianAwareDataView = void 0;
const underscore_1 = __importDefault(require("underscore"));
const _is_little_endian = (function () {
    var x = new ArrayBuffer(4);
    var bytes = new Uint8Array(x), words = new Uint32Array(x);
    bytes[0] = 1;
    if (words[0] === 1) {
        return true;
    }
...
exports.EndianAwareDataView = EndianAwareDataView;
const my_ArrayBufferView = function (b, o, l) {
    o = underscore_1.default.isUndefined(o) ? 0 : o;
    l = underscore_1.default.isUndefined(l) ? b.byteLength : l;
    return {
        buffer: b,
        offset: o,
        length: l,
        data_view: function () {
            return new EndianAwareDataView(this.buffer, this.offset, this.buffer.byteLength - this.offset);
        },
        make: function (ctor, new_offset, new_length) {
            new_offset = underscore_1.default.isUndefined(new_offset) ? 0 : new_offset;
            new_length = underscore_1.default.isUndefined(new_length) ? this.length : new_length;
        ...
        skip: function (offset) {
            return my_ArrayBufferView(this.buffer, this.offset + offset, this.buffer.byteLength);
        },
...
exports.my_ArrayBufferView = my_ArrayBufferView;
